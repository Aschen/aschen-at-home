...
class SeasonsControllerTest < ActionController::TestCase
  ...
  test "should create season" do
    assert_difference('Season.count') do
      post :create, season: { auto_download: @season.auto_download, episodes_count: @season.episodes_count, number: @season.number, series_id: @season.series_id }
    end
  ...
  test "should update season" do
    patch :update, id: @season, season: { auto_download: @season.auto_download, episodes_count: @season.episodes_count, number: @season.number, series_id: @season.series_id }
    assert_redirected_to season_path(assigns(:season))
  end
